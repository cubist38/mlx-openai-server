...
class OpenAIBaseModel(BaseModel):
    """Base model for OpenAI-compatible API schemas."""
...
class ImageURL(OpenAIBaseModel):
    """Schema for image URL references."""
...
class ChatCompletionContentPartImage(OpenAIBaseModel):
    """Content part for image data in chat completions."""
...
class ChatCompletionContentPartVideo(OpenAIBaseModel):
    """Content part for video data in chat completions."""
...
class ChatCompletionContentPartInputAudio(OpenAIBaseModel):
    """Content part for input audio data in chat completions."""
...
class ChatCompletionContentPartText(OpenAIBaseModel):
    """Content part for text data in chat completions."""
...
class PromptTokenUsageInfo(OpenAIBaseModel):
    """Schema for prompt token usage details."""
...
class TranscriptionUsageAudio(OpenAIBaseModel):
    """Schema for transcription audio usage information."""
...
class TranscriptionResponseStreamChoice(OpenAIBaseModel):
    """Schema for transcription streaming response choice."""
...
class TranscriptionResponseStream(OpenAIBaseModel):
    """Schema for transcription streaming response."""
