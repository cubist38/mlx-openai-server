...
class MLX_LM:
    ...
    def __init__(self, model_path: str, context_length: int | None = None, trust_remote_code: bool = False, chat_template_file: str = None, extra_stop_tokens: List[int] | None = None):
        """
