...
if __name__ == "__main__":
    ...
    thinking_parser: Ministral3ThinkingParser | None = Ministral3ThinkingParser()
    tool_parser: Ministral3ToolParser | None = Ministral3ToolParser()
    ...
    for chunk in streaming_response:
        if not chunk:
            continue
        # support streaming chunks that can be either str or objects with .text
