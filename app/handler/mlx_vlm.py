...
class MLXVLMHandler:
    ...
    async def _prepare_multimodal_request(self, request: ChatCompletionRequest) -> dict[str, Any]:
        ...
        This method extracts text messages, image URLs, and audio data from the request,
        processes them to get local file paths, and prepares model parameters for inference.
        ...
        -------
        dict[str, Any]
            Dictionary containing processed request data ready for model inference,
            including messages, image/audio/video paths, and model parameters.
        """
        chat_messages = []
        images = []
        audios = []
