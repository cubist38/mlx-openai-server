"""Parser for Ministral3 model responses."""
...
class Ministral3ToolState:
    """Enum for Ministral3 tool parsing states."""
...
class Ministral3ToolParser(BaseToolParser):
    ...
    def __init__(self) -> None:
        ...
        self._tool_open_len = len(self.tool_open)
    ...
    def parse(self, content: str) -> tuple[list[dict[str, Any]], str]:
        ...
        while True:
            ...
            try:
                ...
                logger.error("Error parsing tool call: %s", tool_content)
        ...
        if self.ministral3_tool_state == Ministral3ToolState.FOUND_PREFIX:
            ...
            if start_argument_index != -1:
                ...
                self.mistral_tool_arguments += chunk[
                    start_argument_index + self._argument_open_len :
                ]
                return res, False
        ...
        if self.ministral3_tool_state == Ministral3ToolState.FOUND_ARGUMENTS:
            ...
            if end_tool_index != -1:
                ...
                if json_output is None:
                    logger.error("Failed to parse tool content: %s", self.buffer)
                    return res, False
