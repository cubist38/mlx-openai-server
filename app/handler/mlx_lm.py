...
class MLXLMHandler:
    ...
    def __init__(self, model_path: str, context_length: int = None, max_concurrency: int = 1, enable_auto_tool_choice: bool = False, tool_call_parser: str = None, reasoning_parser: str = None, pipeline: bool = False):
        """
        ...
        self.model = MLX_LM(model_path, context_length, pipeline=pipeline)
