    ...
    async def _process_request(self, request_data: dict[str, Any]) -> tuple[Any, int]:
        ...
        try:
            ...
            if request_data.get("type") == "embeddings":
                embeddings_result = self.model.get_embeddings(request_data["input"])
            ...
            # Call the model
            model_result = self.model(messages=refined_messages, stream=stream, **model_params)
            text_response: Any
            if isinstance(model_result, tuple):
                text_response, _ = model_result
            else:
                text_response = model_result
            ...
            return text_response, prompt_tokens
